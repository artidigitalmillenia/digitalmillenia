            ...
            <div class="row">
              <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                <div class="sec-title-wrapper">
                  <h2 class="sec-title animation__char_come">Cloud Services</h2>
                </div>
              </div>
              <div class="col-md-7">
                <div class="development__wrapper">
                  <div class="development__content">
                    <p>Our seasoned Cloud Engineers are specialists in designing, implementing, and maintaining cloud infrastructure. Proficient in platforms like AWS, Azure, or Google Cloud, they architect scalable and secure solutions. Our engineers excel in automation using tools like Terraform or Ansible, optimizing performance, and ensuring high availability. They are adept at containerization with Docker and orchestration with Kubernetes. Security expertise in identity management, encryption, and compliance is integral to their profile. Experienced cloud engineers possess strong troubleshooting skills, stay updated on emerging technologies, and contribute to continuous improvement in cloud architecture for enhanced reliability, scalability, and cost-efficiency.</p>
                  </div>
                  <ul>
