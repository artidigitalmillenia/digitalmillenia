            ...
            <div class="row">
              ...
              <div class="col-xxl-8 col-xl-10 offset-xxl-2 offset-xl-1">
                ...
                <div class="blog__detail-tags">
                  <p class="sub-title-anim">tags: <a href="tag.php">design</a>, <a href="tag.php">figma</a>,
                    <a href="tag.php">update</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row reset-grid">
              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <article class="blog__item">
                  ...
                  <h4 class="blog__meta sub-title-anim"><a href="category.php">UI Design</a> . 02 May 2019</h4>
                  <h5><a href="blog-details.php" class="blog__title sub-title-anim">Ways of lying to yourself about
                      your new
                      relationship.</a></h5>
                  <a href="blog-details.php" class="blog__btn">Read More <span><i
              ...
              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <article class="blog__item" data-speed="auto">
                  ...
                  <h4 class="blog__meta sub-title-anim"><a href="category.php">UI Design</a> . 02 May 2019</h4>
                  <h5><a href="blog-details.php" class="blog__title sub-title-anim">How to manage a talented and
                      successful de sign
                      team</a></h5>
                  <a href="blog-details.php" class="blog__btn">Read More <span><i
                        class="fa-solid fa-arrow-right"></i></span></a>
              ...
              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <article class="blog__item" data-speed="auto">
                  ...
                  <h4 class="blog__meta sub-title-anim"><a href="category.php">UI Design</a> . 02 May 2019</h4>
                  <h5><a href="blog-details.php" class="blog__title sub-title-anim">How to bring fold to your startup
                      company with
                      Axtra</a></h5>
                  <a href="blog-details.php" class="blog__btn">Read More <span><i
                        class="fa-solid fa-arrow-right"></i></span></a>
