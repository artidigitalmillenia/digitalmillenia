            ...
            <div class="row">
              <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                <div class="sec-title-wrapper">
                  <h2 class="sec-title animation__char_come">Cross Platform Applications</h2>
                </div>
              </div>
              <div class="col-md-7">
                <div class="development__wrapper">
                  <div class="development__content">
                    <p>Our adept Cross-Platform Applications Developers possess a robust skill set in frameworks like React Native, Flutter, or Xamarin. Proficient in languages such as JavaScript or Dart, they possess a comprehensive understanding of mobile and web development. Their expertise lies in creating versatile, efficient, and user-friendly applications that seamlessly operate across diverse platforms. Experienced developers demonstrate a deep knowledge of UI/UX design, API integration, and performance optimization. With a proven track record, they navigate the challenges of cross-platform development, ensuring consistent functionality and a superior user experience across various devices and operating systems.</p>
                  </div>
                  <ul>
